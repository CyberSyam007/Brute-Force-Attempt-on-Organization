---
# Brute-Force-Attempt-on-Organization
...
| where NumberOfFailures >= 20
```

![Screenshot 2025-04-28 105127](https://github.com/user-attachments/assets/3acaa22b-c771-4b66-b813-89504797abdd)


- **Eight Azure VMs** were targeted by brute force attempts from **Ten** public IPs and **one** private IP:


![Screenshot 2025-04-28 111226](https://github.com/user-attachments/assets/e6547f31-76fa-438b-832e-98e35558c2b0)


- KQL Query to detect failed logins:  
  ```kql
   DeviceLogonEvents
   | where RemoteIP in ("185.243.96.107","189.167.233.242","10.0.0.8","95.143.191.9","218.92.0.187","92.63.197.9","103.250.151.202","57.128.220.79","196.251.88.103","116.198.207.211","92.63.197.9")
   | where ActionType == "LogonSuccess"
   | project DeviceName, RemoteIP, TimeGenerated
  ```
...
![Screenshot 2025-04-28 110710](https://github.com/user-attachments/assets/a52dc391-f7d5-4dc5-9989-91ba4f9b5666)
